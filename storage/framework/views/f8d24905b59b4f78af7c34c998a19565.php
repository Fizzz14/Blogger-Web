...
<?php $__env->startSection('title', 'Dashboard - BACAKUY'); ?>
        ...
        <div class="card card-primary text-white">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col">
                        <h3 class="mb-1">Selamat datang, <?php echo e(auth()->user()->name); ?>! 👋</h3>
                        <p class="mb-0 opacity-75">Ada artikel menarik apa hari ini?</p>
                    </div>
                    <div class="col-auto">
                        <div class="row text-center">
                            <div class="col">
                                <h4 class="mb-0"><?php echo e($userStats['articles_read']); ?></h4>
                                <small>Artikel Dibaca</small>
                            </div>
                            <div class="col">
                                <h4 class="mb-0"><?php echo e($userStats['comments_made']); ?></h4>
                                <small>Komentar</small>
                            </div>
                            <div class="col">
                                <h4 class="mb-0"><?php echo e($userStats['likes_given']); ?></h4>
                                <small>Likes</small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <form action="<?php echo e(route('reader.articles')); ?>" method="GET" class="d-flex">
    ...
    <div class="col-12 mb-4">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        <a href="<?php echo e(route('reader.articles')); ?>" class="btn btn-primary d-flex flex-column align-items-center p-3 h-100 text-white text-decoration-none">
                            <i class="bi bi-journal-text fs-1 mb-2"></i>
                            <span>Browse Articles</span>
                        </a>
                    </div>
                    <div class="col-md-3">
                        <a href="<?php echo e(route('reader.articles')); ?>" class="btn btn-success d-flex flex-column align-items-center p-3 h-100 text-white text-decoration-none">
                            <i class="bi bi-plus-circle fs-1 mb-2"></i>
                            <span>New Article</span>
                        </a>
                    </div>
                    <div class="col-md-3">
                        <a href="<?php echo e(route('reader.articles')); ?>" class="btn btn-info d-flex flex-column align-items-center p-3 h-100 text-white text-decoration-none">
                            <i class="bi bi-bookmark-star fs-1 mb-2"></i>
                            <span>Bookmarks</span>
                        </a>
                    </div>
                    <div class="col-md-3">
                        <a href="<?php echo e(route('reader.articles')); ?>" class="btn btn-warning d-flex flex-column align-items-center p-3 h-100 text-white text-decoration-none">
    ...
    <div class="col-12">
        <div class="card news-card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('reader.articles')); ?>" class="btn btn-sm btn-outline-primary">
                ...
                <div class="news-article">
                    <div class="row g-0">
                        ...
                        <div class="col-md-5">
                            ...
                            <a href="<?php echo e(route('reader.article.show', $article)); ?>">
                        ...
                        <div class="col-md-7">
                            <div class="news-content">
                                ...
                                <div class="article-header d-flex align-items-center mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="article-meta d-flex align-items-center text-muted small">
                                            <span class="me-3">
                                                <i class="bi bi-calendar3 me-1"></i><?php echo e($article->created_at->format('M d, Y')); ?>

                                            </span>
                                            <span class="me-3">
                                                <i class="bi bi-eye me-1"></i><?php echo e($article->view_count); ?> views
                                            </span>
                                            <span class="badge px-2 py-1" style="background-color: <?php echo e($article->category->color); ?>;">
                                ...
                                <h3 class="article-title mb-3">
                                    <a href="<?php echo e(route('reader.article.show', $article)); ?>" class="text-decoration-none text-dark">
                                ...
                                <div class="article-excerpt mb-3">
                                    <p class="text-muted mb-0">
                                        <?php echo e(Str::limit($article->excerpt ?: strip_tags($article->content), 150)); ?>

                                    </p>
                                    <a href="<?php echo e(route('reader.article.show', $article)); ?>" class="text-primary text-decoration-none fw-bold mt-3 d-inline-block">
                                ...
                                <div class="engagement-bar">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex gap-4">
                                            ...
                                            ?>
                                            <button class="btn btn-link text-dark p-0 like-btn d-flex align-items-center <?php echo e($isLiked ? 'liked' : ''); ?>" data-article-id="<?php echo e($article->id); ?>">
                                                <i class="bi <?php echo e($isLiked ? 'bi-heart-fill' : 'bi-heart'); ?> fs-5 me-1"></i>
                                                <span class="like-count"><?php echo e($article->like_count); ?></span>
                                            </button>
                                            <a href="<?php echo e(route('reader.article.show', $article)); ?>#comments" class="btn btn-link text-dark p-0 d-flex align-items-center">
                                                <i class="bi bi-chat fs-5 me-1"></i>
                                                <span><?php echo e($article->comments_count ?? 0); ?></span>
                                            </a>
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="<?php echo e(route('reader.article.show', $article)); ?>"
                       class="list-group-item list-group-item-action bg-transparent text-light border-secondary">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <small class="text-muted"><?php echo e($article->category->name); ?></small>
                            <small class="text-muted">
...
<?php echo $__env->make('template.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Hafizh\Blogger.web\resources\views\reader\dashboard.blade.php ENDPATH**/ ?>