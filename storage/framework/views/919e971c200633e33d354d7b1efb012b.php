            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="<?php echo e(route('admin.comments.show', $comment)); ?>" class="btn btn-default btn-sm">
                            <i class="fas fa-arrow-left"></i> Back to Comment
                        </a>
                    </div>
                </div>
                <form action="<?php echo e(route('admin.comments.update', $comment)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="<?php echo e(route('admin.comments.show', $comment)); ?>" class="btn btn-default">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('template.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Hafizh\Blogger.web\resources\views\admin\comments\edit.blade.php ENDPATH**/ ?>