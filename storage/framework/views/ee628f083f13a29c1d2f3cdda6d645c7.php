    ...
    <div class="col-12">
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="filterDropdown">
                ...
                <li><a class="dropdown-item" href="#" data-filter="published">Dipublikasikan</a></li>
        ...
        <div>
            <div class="btn-group me-2">
                <button type="button" class="btn btn-sm btn-success dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                    <i class="bi bi-file-earmark-excel me-1 href="<?php echo e(route('admin.categories.export')); ?>"></i>Export
                </button>
            </div>
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <form action="<?php echo e(route('admin.categories.import')); ?>" method="POST" enctype="multipart/form-data" class="p-2">
                            <?php echo csrf_field(); ?>
                            <div class="mb-2">
...
<?php echo $__env->make('template.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Hafizh\Blogger.web\resources\views\admin\categories\index.blade.php ENDPATH**/ ?>