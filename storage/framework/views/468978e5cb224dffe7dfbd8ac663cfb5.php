...
<div class="row">
    ...
    <div class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="position-sticky pt-3">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('staff.comments.*') ? 'active' : ''); ?>" href="<?php echo e(route('staff.comments.index')); ?>">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <?php echo $__env->yieldContent('staff_content'); ?>
    </main>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('template.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Hafizh\Blogger.web\resources\views/template/staff.blade.php ENDPATH**/ ?>