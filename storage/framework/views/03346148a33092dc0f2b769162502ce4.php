...
<?php $__env->startSection('title', $category->name . ' Articles'); ?>
    ...
    <div class="col-lg-8">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <h1 class="gradient-text mb-3"><?php echo e($category->name); ?> Articles</h1>
                <p class="text-muted"><?php echo e($articles->count()); ?> articles in this category</p>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="list-group list-group-flush">
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('reader.articles.category', $cat)); ?>"
                           class="list-group-item list-group-item-action d-flex justify-content-between align-items-center <?php echo e($cat->id === $category->id ? 'active' : ''); ?>">
                            <span><?php echo e($cat->name); ?></span>
                            <span class="badge bg-primary rounded-pill"><?php echo e($cat->articles()->published()->count()); ?></span>
                        </a>
...
<?php echo $__env->make('template.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Hafizh\Blogger.web\resources\views\reader\articles-category.blade.php ENDPATH**/ ?>