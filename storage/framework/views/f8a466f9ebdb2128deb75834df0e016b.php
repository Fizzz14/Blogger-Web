            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="<?php echo e(route('staff.comments.datatables')); ?>" class="btn btn-default btn-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <div>
                            <a href="<?php echo e(route('staff.comments.edit', $comment)); ?>" class="btn btn-warning">
                                <i class="fas fa-edit"></i> Edit Comment
                            </a>
                        </div>
                        <div>
                            <?php if($comment->is_approved): ?>
                                <form action="<?php echo e(route('staff.comments.unapprove', $comment)); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('template.staff', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Hafizh\Blogger.web\resources\views/staff/comments/show.blade.php ENDPATH**/ ?>