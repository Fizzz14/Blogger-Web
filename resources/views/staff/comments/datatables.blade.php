...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{ route('staff.comments.index') }}" class="btn btn-secondary me-2">
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div>
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ asset('storage/templates/comments_import_template.xlsx') }}" download>Download Template</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li>
                        <form action="{{ route('staff.comments.import') }}" method="POST" enctype="multipart/form-data" class="p-2">
                            @csrf
                            <div class="mb-2">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-3">
                <select class="form-select" id="article-filter">
                    ...
                    <option value="{{ $article->id }}">{{ Str::limit($article->title, 30) }}</option>
                    @endforeach
                </select>
            </div>
        </div>
...
$(document).ready(function() {
    var table = $('#comments-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route("staff.comments.datatables") }}',
            data: function(d) {
