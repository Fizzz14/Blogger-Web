        ...
        <div>
            <div class="btn-group me-2">
                <button type="button" class="btn btn-sm btn-success dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                    <i class="bi bi-file-earmark-excel me-1 href="{{ route('admin.categories.export') }}"></i>Export
                </button>
            </div>
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <form action="{{ route('admin.categories.import') }}" method="POST" enctype="multipart/form-data" class="p-2">
                            @csrf
                            <div class="mb-2">
