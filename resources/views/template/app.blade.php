...
<head>
    ...
    <title>@yield('title', 'Bacakuy')</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold gradient-text d-flex align-items-center" href="{{ route('dashboard') }}">
                <img src="{{ asset('Image/buku.png') }}" alt="Bacakuy" class="me-2"
                    ...
                    @auth
                        ...
                        <li class="nav-item">
                            <div class="navbar-text me-3">
                                <img src="{{ auth()->user()->getAvatarUrl() }}" alt="Avatar" class="rounded-circle me-2"
                                    width="32" height="32">
